    ...
    <div class="row">
      <div class="col-md-3">
        <div class="shop_colmn1">
          <h4 class="prod_head_2">Completed projects</h4>
          <button class="collapse_b" data-toggle="collapse" data-target="#demo">Completed projects <i
              class="fa fa-bars"></i></button>
          <div id="demo" class="collapse">
            <ul class="shop_nav__1">
              <?php foreach ($project_data as $item): ?>
                <li><a href="<?= MAINSITE . "completed-projects/" . $item->slug_url ?>"
